...
class BuilderForm extends Builder
{
    ...
    protected $fieldsItemsList = ['text','number','url','info','section','date','datetime','daterange','hidden','readonly','password','left_icon_text','right_icon_text','left_icon_number','right_icon_number','textarea','ueditor','wangeditor','radio','checkbox','select','select2','select3','select_multiple','tags','multilayer_select','email','group','icon','avatar','picture','pictures','image','file','files','repeater','self','self_html','tab'];
